...
class updates(modules.Module):
    ...
    def start_service(self):
        try:
            oe.dbg_log('updates::start_service', 'enter_function', oe.LOGDEBUG)
            self.is_service = True
            self.load_values()
            self.set_auto_update()
            del self.is_service
            oe.dbg_log('updates::start_service', 'exit_function', oe.LOGDEBUG)
        except Exception as e:
            oe.dbg_log('updates::start_service', f'ERROR: ({repr(e)})')

    def stop_service(self):
        try:
            oe.dbg_log('updates::stop_service', 'enter_function', oe.LOGDEBUG)
            if hasattr(self, 'update_thread'):
                self.update_thread.stop()
            oe.dbg_log('updates::stop_service', 'exit_function', oe.LOGDEBUG)
        except Exception as e:
            oe.dbg_log('updates::stop_service', f'ERROR: ({repr(e)})')

    def do_init(self):
        try:
            oe.dbg_log('updates::do_init', 'enter_function', oe.LOGDEBUG)
            oe.dbg_log('updates::do_init', 'exit_function', oe.LOGDEBUG)
        except Exception as e:
            oe.dbg_log('updates::do_init', f'ERROR: ({repr(e)})')

    def exit(self):
        oe.dbg_log('updates::exit', 'enter_function', oe.LOGDEBUG)
        oe.dbg_log('updates::exit', 'exit_function', oe.LOGDEBUG)
        pass
    ...
    def load_values(self):
        try:
            oe.dbg_log('updates::load_values', 'enter_function', oe.LOGDEBUG)
            ...
            oe.dbg_log('updates::load_values', 'exit_function', oe.LOGDEBUG)

        except Exception as e:
            oe.dbg_log('updates::load_values', f'ERROR: ({repr(e)})')

    def load_menu(self, focusItem):
        try:
            oe.dbg_log('updates::load_menu', 'enter_function', oe.LOGDEBUG)
            oe.winOeMain.build_menu(self.struct)
            oe.dbg_log('updates::load_menu', 'exit_function', oe.LOGDEBUG)
        except Exception as e:
            oe.dbg_log('updates::load_menu', f'ERROR: ({repr(e)})')

    def set_value(self, listItem):
        try:
            oe.dbg_log('updates::set_value', 'enter_function', oe.LOGDEBUG)
            self.struct[listItem.getProperty('category')]['settings'][listItem.getProperty('entry')]['value'] = listItem.getProperty('value')
            oe.write_setting('updates', listItem.getProperty('entry'), str(listItem.getProperty('value')))
            oe.dbg_log('updates::set_value', 'exit_function', oe.LOGDEBUG)
        except Exception as e:
            oe.dbg_log('updates::set_value', f'ERROR: ({repr(e)})')

    def set_auto_update(self, listItem=None):
        try:
            oe.dbg_log('updates::set_auto_update', 'enter_function', oe.LOGDEBUG)
            ...
            oe.dbg_log('updates::set_auto_update', 'exit_function', oe.LOGDEBUG)
        except Exception as e:
            oe.dbg_log('updates::set_auto_update', f'ERROR: ({repr(e)})')

    def set_channel(self, listItem=None):
        try:
            oe.dbg_log('updates::set_channel', 'enter_function', oe.LOGDEBUG)
            if not listItem == None:
                self.set_value(listItem)
            self.struct['update']['settings']['Build']['values'] = self.get_available_builds()
            oe.dbg_log('updates::set_channel', 'exit_function', oe.LOGDEBUG)
        except Exception as e:
            oe.dbg_log('updates::set_channel', f'ERROR: ({repr(e)})')

    def set_custom_channel(self, listItem=None):
        try:
            oe.dbg_log('updates::set_custom_channel', 'enter_function', oe.LOGDEBUG)
            if not listItem == None:
                self.set_value(listItem)
            self.update_json = self.build_json()
            self.struct['update']['settings']['Channel']['values'] = self.get_channels()
            ...
            self.struct['update']['settings']['Build']['values'] = self.get_available_builds()
            oe.dbg_log('updates::set_custom_channel', 'exit_function', oe.LOGDEBUG)
        except Exception as e:
            oe.dbg_log('updates::set_custom_channel', f'ERROR: ({repr(e)})')
    ...
    def get_channels(self):
        try:
            oe.dbg_log('updates::get_channels', 'enter_function', oe.LOGDEBUG)
            channels = []
            ...
            oe.dbg_log('updates::get_channels', 'exit_function', oe.LOGDEBUG)
            return sorted(list(set(channels)), key=cmp_to_key(self.custom_sort_train))
        except Exception as e:
            oe.dbg_log('updates::get_channels', f'ERROR: ({repr(e)})')

    def do_manual_update(self, listItem=None):
        try:
            oe.dbg_log('updates::do_manual_update', 'enter_function', oe.LOGDEBUG)
            ...
            if buildSel > -1:
                ...
                if self.struct['update']['settings']['Build']['value'] != '':
                    ...
                    if answer:
                        ...
                        self.do_autoupdate()
                self.struct['update']['settings']['Build']['value'] = ''
            oe.dbg_log('updates::do_manual_update', 'exit_function', oe.LOGDEBUG)
        except Exception as e:
            oe.dbg_log('updates::do_manual_update', f'ERROR: ({repr(e)})')

    def get_json(self, url=None):
        try:
            oe.dbg_log('updates::get_json', 'enter_function', oe.LOGDEBUG)
            if url is None:
            ...
            if not data is None:
                ...
                update_json = None
            oe.dbg_log('updates::get_json', 'exit_function', oe.LOGDEBUG)
            return update_json
        except Exception as e:
            oe.dbg_log('updates::get_json', f'ERROR: ({repr(e)})')

    def build_json(self, notify_error=False):
        try:
            oe.dbg_log('updates::build_json', 'enter_function', oe.LOGDEBUG)
                ...
                for custom_url in custom_urls:
                    if custom_url != '':
                        ...
                        if not custom_update_json is None:
                            ...
                            if not answer:
                                return
            oe.dbg_log('updates::build_json', 'exit_function', oe.LOGDEBUG)
            return update_json
        except Exception as e:
            oe.dbg_log('updates::build_json', f'ERROR: ({repr(e)})')

    def get_available_builds(self, shortname=None):
        try:
            oe.dbg_log('updates::get_available_builds', 'enter_function', oe.LOGDEBUG)
            channel = self.struct['update']['settings']['Channel']['value']
            update_files = []
            build = None
            if not self.update_json is None:
                            ...
                            for i in sorted(self.update_json[channel]['project'][oe.ARCHITECTURE]['releases'], key=int, reverse=True):
                                if shortname is None:
                                    ...
                                    if shortname in build:
                                        break
            oe.dbg_log('updates::get_available_builds', 'exit_function', oe.LOGDEBUG)
            if build is None:
                return update_files
            else:
                return build
        except Exception as e:
            oe.dbg_log('updates::get_available_builds', f'ERROR: ({repr(e)})')

    def check_updates_v2(self, force=False):
        try:
            oe.dbg_log('updates::check_updates_v2', 'enter_function', oe.LOGDEBUG)
            ...
            oe.dbg_log('updates::check_updates_v2', 'exit_function', oe.LOGDEBUG)
        except Exception as e:
            oe.dbg_log('updates::check_updates_v2', f'ERROR: ({repr(e)})')

    def do_autoupdate(self, listItem=None, silent=False):
        try:
            oe.dbg_log('updates::do_autoupdate', 'enter_function', oe.LOGDEBUG)
            ...
            oe.dbg_log('updates::do_autoupdate', 'exit_function', oe.LOGDEBUG)
        except Exception as e:
            oe.dbg_log('updates::do_autoupdate', f'ERROR: ({repr(e)})')
    ...
    def get_rpi_eeprom(self, device):
        try:
            oe.dbg_log('updates::get_rpi_eeprom', 'enter_function', oe.LOGDEBUG)
            values = []
            ...
            oe.dbg_log('updates::get_rpi_eeprom', 'exit_function', oe.LOGDEBUG)
            return 'true' if (f'{device}="yes"') in values else 'false'
        except Exception as e:
            oe.dbg_log('updates::get_rpi_eeprom', f'ERROR: ({repr(e)})')

    def set_rpi_eeprom(self):
        try:
            oe.dbg_log('updates::set_rpi_eeprom', 'enter_function', oe.LOGDEBUG)
            ...
            oe.dbg_log('updates::set_rpi_eeprom', 'exit_function', oe.LOGDEBUG)
        except Exception as e:
            oe.dbg_log('updates::set_rpi_eeprom', f'ERROR: ({repr(e)})')

    def set_rpi_bootloader(self, listItem):
        try:
            oe.dbg_log('updates::set_rpi_bootloader', 'enter_function', oe.LOGDEBUG)
            value = 'false'
            ...
            self.set_rpi_eeprom()
            oe.dbg_log('updates::set_rpi_bootloader', 'exit_function', oe.LOGDEBUG)
        except Exception as e:
            oe.dbg_log('updates::set_rpi_bootloader', f'ERROR: ({repr(e)})')

    def set_rpi_vl805(self, listItem):
        try:
            oe.dbg_log('updates::set_rpi_vl805', 'enter_function', oe.LOGDEBUG)
            value = 'false'
            if listItem.getProperty('value') == 'true':
            ...
            self.struct[listItem.getProperty('category')]['settings'][listItem.getProperty('entry')]['value'] = value
            self.set_rpi_eeprom()
            oe.dbg_log('updates::set_rpi_vl805', 'exit_function', oe.LOGDEBUG)
        except Exception as e:
            oe.dbg_log('updates::set_rpi_vl805', f'ERROR: ({repr(e)})')
...
class updateThread(threading.Thread):
    ...
    def __init__(self, oeMain):
        try:
            ...
            oe.dbg_log('updates::updateThread::__init__', 'exit_function', oe.LOGDEBUG)
        except Exception as e:
            oe.dbg_log('updates::updateThread::__init__', f'ERROR: ({repr(e)})')

    def stop(self):
        try:
            oe.dbg_log('updates::updateThread::stop()', 'enter_function', oe.LOGDEBUG)
            self.stopped = True
            self.wait_evt.set()
            oe.dbg_log('updates::updateThread::stop()', 'exit_function', oe.LOGDEBUG)
        except Exception as e:
            oe.dbg_log('updates::updateThread::stop()', f'ERROR: ({repr(e)})')

    def run(self):
        try:
            oe.dbg_log('updates::updateThread::run', 'enter_function', oe.LOGDEBUG)
            ...
            oe.dbg_log('updates::updateThread::run', 'exit_function', oe.LOGDEBUG)
        except Exception as e:
            oe.dbg_log('updates::updateThread::run', f'ERROR: ({repr(e)})')
